pipeline {
    ...
    stages {
        ...
        stage('Build Docker Image') {
            ...
            steps {
                script {
                    app = docker.build("nebojsailic2614/train-schedule")
                    app.inside {
        ...
        stage('DeployToProduction') {
            ...
            steps {
                ...
                milestone(1)
                withCredentials([usernamePassword(credentialsId: 'production-ssh', usernameVariable: 'USERNAME', passwordVariable: 'USERPASS')]) {
                    script {
